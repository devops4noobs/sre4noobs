...
const menuItems: MenuItem[] = [
  { label: 'Home', href: '/', icon: HomeIcon },
  {
    ...
    subItems: [
      ...
      { label: 'Interview questions', href: '/fundamentals/interview-fundamentals', icon: KeyIcon },
    ],
  },
  {
    label: 'SRE Pillars',
