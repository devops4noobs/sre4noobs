  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-indigo-950 to-blue-900 flex flex-col items-center justify-start py-6 md:py-12 overflow-x-hidden relative">
      ...
      <section className="w-full max-w-xs sm:max-w-sm md:max-w-3xl mx-auto text-center px-4 py-8 sm:py-12 mb-6 sm:mb-12 bg-gradient-to-r from-indigo-800 to-blue-800 rounded-xl sm:rounded-2xl shadow-lg transform perspective-1000 hover:rotate-x-2 transition-all duration-500">
        <motion.h1
          className="text-3xl md:text-5xl font-extrabold text-white mb-6 drop-shadow-xl tracking-tight animate-fade-in"
      ...
      <section className="bg-gray-800/80 backdrop-blur-md p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-xl max-w-xs sm:max-w-3xl md:max-w-6xl mx-auto text-center mb-6 sm:mb-12" id="get-started">
