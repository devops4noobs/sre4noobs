...
const principleIcons = [
  <SparklesIcon key="slo" className="w-8 h-8 text-yellow-300" />, // SLOs
  <DocumentTextIcon key="error-budgets" className="w-8 h-8 text-pink-300" />, // Error Budgets
  <Cog6ToothIcon key="automate-toil" className="w-8 h-8 text-indigo-300" />, // Automate Toil
  <UserGroupIcon key="collaboration" className="w-8 h-8 text-blue-300" />, // Collaboration
  <DocumentTextIcon key="postmortems" className="w-8 h-8 text-green-300" />, // Postmortems
  <EyeIcon key="monitoring" className="w-8 h-8 text-indigo-400" />, // Monitoring
  <RocketLaunchIcon key="release-engineering" className="w-8 h-8 text-pink-400" />, // Release Engineering
    ...
    content: (
      <div className="space-y-4 text-gray-300">
        ...
        <ul className="list-disc list-inside space-y-2">
          ...
          <li>Collaborative planning for capacity and incidents</li>
        </ul>
