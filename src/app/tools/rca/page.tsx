  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-indigo-950 to-blue-900 flex flex-col items-center justify-start py-6 md:py-12 overflow-x-hidden relative">
      ...
      <main className="p-4 md:p-6 w-full max-w-xs sm:max-w-sm md:max-w-4xl mx-auto">
        ...
        >
          <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold text-yellow-200 mb-4">Core Concept: Uncovering the Why</h2>
        ...
        <motion.div
          ...
          onHoverEnd={() => setHoveredSection(null)}
        >
          <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold text-yellow-200 mb-4">🎯 Why RCA Matters</h2>
          <p className="text-indigo-100 mb-4 text-sm sm:text-base">
        ...
        <motion.div
          ...
          onHoverEnd={() => setHoveredSection(null)}
        >
          <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold text-yellow-200 mb-4">🏁 Mission: Understand, Resolve, Prevent</h2>
        ...
        <motion.div
          ...
          onHoverEnd={() => setHoveredSection(null)}
        >
          <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold text-yellow-200 mb-4">❓ What Is Root Cause Analysis?</h2>
          <p className="text-indigo-100 mb-4 text-sm sm:text-base">
