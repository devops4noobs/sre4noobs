...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    subItems: [
      { label: 'Embracing Risk', href: '/principles/embracing-risk', icon: ShieldCheckIcon },
      { label: 'SLOs', href: '/principles/slo', icon: ChartBarIcon },
      { label: 'Eliminating Toil', href: '/principles/toil', icon: TrashIcon },
      { label: 'Monitoring', href: '/principles/monitoring', icon: EyeIcon },
      { label: 'Automation', href: '/principles/automation', icon: CogIcon },
      { label: 'Release Engineering', href: '/principles/release-engineering', icon: RocketLaunchIcon },
      { label: 'Simplicity', href: '/principles/simplicity', icon: PuzzlePieceIcon },
    ],
  },
  {
    label: 'Tools',
